...
const DISABLED_CLASSES                = 'classes_to_exclude';
const DISABLED_CLASSES_WP_OPTION_NAME = 'lazy_load_responsive_images_disabled_classes';
const ADDITIONAL_FILTERS  = 'additional_filters';
const ADDITIONAL_FILTERS_WP_OPTION_NAME = 'lazy_load_responsive_images_additional_filters';
const ENABLE_FOR_IFRAMES = 'enable_for_iframes';
const ENABLE_FOR_IFRAMES_WP_OPTION_NAME = 'lazy_load_responsive_images_enable_for_iframes';
const NATIVE_LAZY_LOAD = 'native_lazy_load';
const NATIVE_LAZY_LOAD_WP_OPTION_NAME = 'lazy_load_responsive_images_native_loading_plugin';
const UNVEILHOOKS_PLUGIN = 'unveilhooks_plugin';
const UNVEILHOOKS_PLUGIN_WP_OPTION_NAME = 'lazy_load_responsive_images_unveilhooks_plugin';
const ENABLE_FOR_BACKGROUND_IMAGES = 'enable_for_background_images';
const ENABLE_FOR_BACKGROUND_IMAGES_WP_OPTION_NAME = 'lazy_load_responsive_images_enable_for_background_images';
const ENABLE_FOR_VIDEOS = 'enable_for_videos';
const ENABLE_FOR_VIDEOS_WP_OPTION_NAME = 'lazy_load_responsive_images_enable_for_videos';
const ENABLE_FOR_AUDIOS = 'enable_for_audios';
const ENABLE_FOR_AUDIOS_WP_OPTION_NAME = 'lazy_load_responsive_images_enable_for_audios';
const LOADING_SPINNER = 'loading_spinner';
const LOADING_SPINNER_WP_OPTION_NAME = 'lazy_load_responsive_images_loading_spinner';
const LOADING_SPINNER_COLOR = 'loading_spinner_color';
const LOADING_SPINNER_COLOR_WP_OPTION_NAME = 'lazy_load_responsive_images_loading_spinner_color';
const LOADING_SPINNER_DEFAULT_COLOR = '#333333';
const GRANULAR_DISABLE_OPTION = 'granular_disable_option';
const GRANULAR_DISABLE_OPTION_WP_OPTION_NAME = 'lazy_load_responsive_images_granular_disable_option';
const PROCESS_COMPLETE_MARKUP = 'process_complete_markup';
const PROCESS_COMPLETE_MARKUP_WP_OPTION_NAME = 'lazy_load_responsive_images_process_complete_markup';
const LAZYSIZES_CONFIG = 'lazysizes_config';
const LAZYSIZES_CONFIG_WP_OPTION_NAME = 'lazy_load_responsive_images_lazysizes_config';

const ALLOWED_DESCRIPTION_HTML = array(
	'a' => array( 'href' => array() ),
	'br' => array(),
	'code' => array(),
	'strong' => array(),
...
const ATTRS_TO_STRIP_FROM_FALLBACK_ELEM = 'attrs_to_strip_from_fallback_elem';

$settings = [
	DISABLED_CLASSES   => [
		'wp_option_name' => DISABLED_CLASSES_WP_OPTION_NAME,
		'value' => get_option( DISABLED_CLASSES_WP_OPTION_NAME, '' ),
	...
	ADDITIONAL_FILTERS => [
		'wp_setting' => true,
		'wp_option_name' => ADDITIONAL_FILTERS_WP_OPTION_NAME,
		'value' => get_option( ADDITIONAL_FILTERS_WP_OPTION_NAME, '' ),
	...
	ENABLE_FOR_IFRAMES => [
		'wp_option_name' => ENABLE_FOR_IFRAMES_WP_OPTION_NAME,
		'value' => (bool) get_option( ENABLE_FOR_IFRAMES_WP_OPTION_NAME, '0' ),
	...
	NATIVE_LAZY_LOAD   => [
		'wp_option_name' => NATIVE_LAZY_LOAD_WP_OPTION_NAME,
		'value' => (bool) get_option( NATIVE_LAZY_LOAD_WP_OPTION_NAME, '0' ),
	...
	UNVEILHOOKS_PLUGIN           => [
        'wp_setting' => true,
		'wp_option_name' => UNVEILHOOKS_PLUGIN_WP_OPTION_NAME,
		'value' => (bool) get_option( UNVEILHOOKS_PLUGIN_WP_OPTION_NAME, '0' ),
	...
	ENABLE_FOR_BACKGROUND_IMAGES => [
		'wp_option_name' => ENABLE_FOR_BACKGROUND_IMAGES_WP_OPTION_NAME,
		'value' => (bool) get_option( ENABLE_FOR_BACKGROUND_IMAGES_WP_OPTION_NAME, '0' ),
	...
	ENABLE_FOR_VIDEOS => [
		'wp_option_name' => ENABLE_FOR_VIDEOS_WP_OPTION_NAME,
		'value' => (bool) get_option( ENABLE_FOR_VIDEOS_WP_OPTION_NAME, '0' ),
	...
	ENABLE_FOR_AUDIOS => [
		'wp_option_name' => ENABLE_FOR_AUDIOS_WP_OPTION_NAME,
		'value' => (bool) get_option( ENABLE_FOR_AUDIOS_WP_OPTION_NAME, '0' ),
	...
	LOADING_SPINNER       => [
        'wp_setting' => true,
		'wp_option_name' => LOADING_SPINNER_WP_OPTION_NAME,
		'value' => (bool) get_option( LOADING_SPINNER_WP_OPTION_NAME, '0' ),
	...
	LOADING_SPINNER_COLOR   => [
        'wp_setting' => true,
		'wp_option_name' => LOADING_SPINNER_COLOR_WP_OPTION_NAME,
		'value' => get_option( LOADING_SPINNER_COLOR_WP_OPTION_NAME, LOADING_SPINNER_DEFAULT_COLOR ),
	...
	GRANULAR_DISABLE_OPTION => [
        'wp_setting' => true,
		'wp_option_name' => GRANULAR_DISABLE_OPTION_WP_OPTION_NAME,
		'value' => (bool) get_option( GRANULAR_DISABLE_OPTION_WP_OPTION_NAME, '0' ),
	...
	PROCESS_COMPLETE_MARKUP => [
        'wp_setting' => true,
		'wp_option_name' => PROCESS_COMPLETE_MARKUP_WP_OPTION_NAME,
		'value' => (bool) get_option( PROCESS_COMPLETE_MARKUP_WP_OPTION_NAME, '0' ),
	...
	LAZYSIZES_CONFIG        => [
        'wp_setting' => true,
		'wp_option_name' => LAZYSIZES_CONFIG_WP_OPTION_NAME,
		'value' => get_option( LAZYSIZES_CONFIG_WP_OPTION_NAME, '' ),
